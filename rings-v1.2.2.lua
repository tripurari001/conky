...
+ v1.0 -- Original release (28.09.2009)
        ...
        arg=conky_parse("${if_up wlp3s0}wlp3s0${else}enp2s0${endif}"),
        fg_colour=0xf0651f,
        fg_colour=conky_parse("${if_up wlp3s0}wlp3s0${else}enp2s0${endif}"),
        conky_parse("${cpu}")
...
function iface_watch()
    ...
    iface=conky_parse("${if_existing /proc/net/route wlp3s0}wlp3s0${else}enp2s0${endif}")
